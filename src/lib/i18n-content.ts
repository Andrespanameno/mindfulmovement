...
export const MILESTONE_ES: Record<string, { label: string; description: string }> = {
  ...
  "streak-30": { label: "Constancia de 30 días", description: "Un mes completo de presencia." },
  "streak-60": { label: "Ritmo de 60 días", description: "Dos meses de ritmo constante." },
  "streak-100": { label: "Estilo de vida 100 días", description: "Ya no es una racha, es tu estilo de vida." },
  "xp-2500": { label: "2,500 XP", description: "El ritmo se está construyendo." },
  "xp-5000": { label: "5,000 XP", description: "A mitad de camino de un gran logro." },
  "xp-10000": { label: "10,000 XP", description: "Un trabajo increíble." },
  "xp-25000": { label: "25,000 XP", description: "Un estilo de vida de movimiento consciente." },
  "sessions-10": { label: "10 sesiones guiadas", description: "Diez sesiones suaves completadas." },
  "sessions-25": { label: "25 sesiones guiadas", description: "Una práctica sólida en formación." },
  "sessions-50": { label: "50 sesiones guiadas", description: "Cincuenta sesiones conscientes." },
  "sessions-100": { label: "100 sesiones guiadas", description: "Un siglo de sesiones." },
  "minutes-60": { label: "60 minutos de movimiento", description: "Una hora de movimiento consciente." },
  "minutes-300": { label: "300 minutos de movimiento", description: "Cinco horas de movimiento." },
  "minutes-600": { label: "600 minutos de movimiento", description: "Diez horas de movimiento consciente." },
  "minutes-1000": { label: "1,000 minutos de movimiento", description: "Mil minutos en movimiento." },
  "hydration-5": { label: "5 días hidratado", description: "Cinco días bien hidratado." },
  "hydration-25": { label: "25 días hidratado", description: "Un hábito constante de hidratación." },
  "hydration-50": { label: "50 días hidratado", description: "Cincuenta días bien hidratado." },
  "breathing-10": { label: "10 sesiones de respiración", description: "Diez sesiones conscientes de respiración." },
  "breathing-25": { label: "25 sesiones de respiración", description: "Un hábito de respiración que calma." },
};
