...
export const MILESTONE_ES: Record<string, { label: string; description: string }> = {
  ...
  "streak-3": { label: "Chispa de 3 días", description: "Tres días suaves, uno tras otro." },
  "streak-7": { label: "Brillo de 7 días", description: "Una semana entera de presencia." },
  "streak-14": { label: "Flujo de dos semanas", description: "La constancia se está volviendo parte de ti." },
  "hydrated": { label: "Día hidratado", description: "Llegaste a tu meta de agua." },
  "xp-1000": { label: "1,000 XP", description: "Pequeñas acciones, gran cambio." },
};
...
export const MOVEMENT_ES: Record<string, { title: string; description: string; instruction?: string }> = {
  ...
  "ankle-circles": { title: "Círculos de tobillos", description: "Despierta los tobillos sin levantarte del escritorio." },
  ...
  "seated-marches": { title: "Marcha sentado", description: "Marcha en el lugar desde tu silla." },
  "walk-3min": { title: "Caminata de 3 minutos", description: "Despégate de la pantalla y reinicia." },
  ...
  "toe-taps": { title: "Toques con la punta del pie", description: "Toques rápidos para levantar la energía." },
  ...
  "overhead-reach": { title: "Estirar hacia arriba", description: "Estiramientos altos para alargar la columna.", instruction: "Levanta los brazos hacia arriba y alarga el cuerpo." },
  ...
  "hip-opener": { title: "Apertura de cadera", description: "Estiramiento suave para las caderas tensas." },
  ...
  "standing-mobility": { title: "Movilidad de pie", description: "Una secuencia suave de pies a cabeza." },
  "deep-breathing": { title: "Respiración profunda", description: "Respira despacio y vuelve a tu centro.", instruction: "Inhala despacio y exhala con control." },
  "mindful-standing": { title: "Pausa consciente de pie", description: "Ponte de pie, relájate y respira.", instruction: "Siéntate o ponte de pie, relaja los hombros y alinea la columna." },
  "one-min-stretch": { title: "Estiramiento de 1 minuto", description: "Lo que tu cuerpo te pida, con calma." },
  "hydration-breath": { title: "Hidratación y respiración", description: "Un sorbo de agua y tres respiraciones lentas." },
  "seated-mobility": { title: "Movilidad sentado", description: "Movimiento suave sin tener que levantarte." },
  "gentle-arm-raises": { title: "Elevaciones suaves de brazos", description: "Elevaciones lentas, respirando al mismo ritmo." },
  ...
  "squats": { title: "Sentadillas conscientes", description: "Doce sentadillas lentas y con intención." },
  ...
  "wall-pushups": { title: "Lagartijas en pared", description: "Diez lagartijas lentas contra la pared.", instruction: "Mantén el cuerpo recto y bájate hacia la pared con control." },
  "countertop-pushups": { title: "Lagartijas en la barra", description: "Diez lagartijas apoyándote en la barra de la cocina." },
  "calf-raises": { title: "Elevaciones de talones", description: "Dos series lentas, respirando en cada una.", instruction: "Sube en puntas de pie, pausa breve y baja despacio." },
  "wall-sit": { title: "Sentadilla en pared", description: "Aguanta un poco, contando respiraciones tranquilas." },
  ...
  "toy-pickup-squats": { title: "Sentadillas recogiendo juguetes", description: "Vuelve la recogida en sentadillas conscientes." },
  ...
  "family-break": { title: "Pausa familiar", description: "Un estiramiento de dos minutos en familia." },
  "baby-bounce-calf": { title: "Elevaciones de talones con el bebé", description: "Calmas y fortaleces al mismo tiempo." },
  ...
  "tension-release-breath": { title: "Respiración para liberar tensión", description: "Respira hacia los puntos tensos y luego suelta." },
  "mindful-breath-reset": { title: "Pausa consciente de respiración", description: "Tres respiraciones con intención, ahora mismo." },
  "hydration-reminder": { title: "Recordatorio de hidratación", description: "Un vaso de agua, despacio y con calma." },
  "water-stretch-combo": { title: "Agua + estiramiento", description: "Toma un sorbo, párate, estírate y repite." },
  ...
  "fresh-air-reset": { title: "Pausa de aire fresco", description: "Unas respiraciones de aire fresco al aire libre." },
  "gratitude-pause": { title: "Pausa de gratitud", description: "Nombra algo por lo que estés agradecido hoy." },
};
