...
const dict: Record<string, { en: string; es: string }> = {
  ...
  "reminders.day.wed": { en: "Wed", es: "Mié" },
  "reminders.day.thu": { en: "Thu", es: "Jue" },
  "reminders.day.fri": { en: "Fri", es: "Vie" },
  "reminders.day.sat": { en: "Sat", es: "Sáb" },
  "reminders.day.sun": { en: "Sun", es: "Dom" },
  "reminders.footer": {
