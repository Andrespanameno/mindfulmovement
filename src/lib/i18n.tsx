...
const dict: Record<string, { en: string; es: string }> = {
  ...
  "auth.signup.title": { en: "Begin your gentle journey", es: "Comienza tu camino con calma" },
  "auth.signup.sub": { en: "Small actions create big change. Create your space.", es: "Pequeñas acciones generan grandes cambios. Crea tu espacio." },
  ...
  "auth.invalid": { en: "Invalid email or password.", es: "Correo o contraseña incorrectos." },
  ...
  "home.hydration.reached": { en: "Goal reached. Beautifully done.", es: "¡Meta lograda! ¡Excelente trabajo!" },
  ...
  "move.featured.completed_one": { en: "1 session completed today. Keep flowing.", es: "1 sesión completada hoy. Sigue con calma." },
  "move.featured.completed_many": { en: "{n} sessions completed today. Keep flowing.", es: "{n} sesiones completadas hoy. Sigue con calma." },
  ...
  "hydration.toast.logged": { en: "+{n} oz logged", es: "+{n} oz registradas" },
  "hydration.toast.xp": { en: "+{xp} XP · Small sips, big impact.", es: "+{xp} XP · Sorbos pequeños, gran impacto." },
  "hydration.toast.keep": { en: "Keep sipping gently.", es: "Sigue tomando con calma." },
  "hydration.toast.goal": { en: "Daily hydration goal reached 🌿", es: "Meta diaria de hidratación lograda 🌿" },
  "hydration.toast.goal_sub": { en: "Beautifully done. Your body thanks you.", es: "¡Excelente trabajo! Tu cuerpo te lo agradece." },
  ...
  "progress.sub": { en: "Small actions, real change, here's how it's adding up.", es: "Acciones pequeñas, cambios reales: así se va sumando." },
  ...
  "progress.peak": { en: "Peak run: {n} days", es: "Mejor constancia: {n} días" },
  ...
  "settings.delete_confirm_desc": {
    ...
    es: "Esto eliminará permanentemente tu perfil, progreso, historial de hidratación, constancia, XP y datos guardados. Esta acción no se puede deshacer.",
  },
  ...
  "reminders.intro": { en: "Soft nudges to move, hydrate, and breathe, only when it fits your day.", es: "Avisos suaves para moverte, hidratarte y respirar, solo cuando encajen en tu día." },
  ...
  "reminders.hydration_desc": { en: "Sip-by-sip check-ins.", es: "Pequeños sorbos a tu propio ritmo." },
